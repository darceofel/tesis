...
\begin{theorem}\label{theorem:im_compact}
...
\begin{lemma}\label{lemma:importante}
...
\begin{proposition}\label{prop:importante}
...
\begin{definition}\label{def:poligono_raro}
...
\begin{proposition}\label{prop:import2}
...
\begin{example}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.6\linewidth]{Cap1/Lynch_example.png}
...
\end{observation*} 
\begin{lemma}\label{lem:a_usar_en_appendice}
...
\begin{theorem}\label{thm:implica_densidad_lynch}
...
\begin{corollary}\label{cor:implica_densidad_lynch}
