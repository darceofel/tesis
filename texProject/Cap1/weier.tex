...
\newpage
\begin{theorem}\label{thm:func_cauchy}
...
\newpage
\begin{theorem}[Prueba M de Weierstrass]\label{thm:M_Weier}
...
\begin{theorem}\label{thm:serie_continua}
...
\begin{corollary}\label{cor:serie_continua}
