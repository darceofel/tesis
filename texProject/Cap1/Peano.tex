...
\begin{theorem}\label{thm:basetres}
...
\begin{definition}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.48\linewidth]{Cap1/peano_phi.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.23\textwidth]{Cap1/peano_1.png}  
    \hspace{0.1cm}  % Horizontal space between images
    \includegraphics[width=0.23\textwidth]{Cap1/peano_2.png}  
    \hspace{0.1cm}  % Horizontal space between images
    \includegraphics[width=0.23\textwidth]{Cap1/peano_3.png}
    \hspace{0.1cm}  % Horizontal space between images
    \includegraphics[width=0.23\textwidth]{Cap1/peano_4.png}
