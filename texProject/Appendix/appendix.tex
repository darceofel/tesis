...
\begin{proposition}\label{appendix:seno_dory}
...
\begin{proposition}\label{appendix:prop:importante}
...
\begin{proposition}\label{appendix:prop:import2}
...
\begin{theorem}\label{appendix:implica_densidad_lynch}
...
\begin{proposition}\label{appendix:obs_cap_2}
