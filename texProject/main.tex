...
%% Para poner más grande el titulo
\font\myfonttitulo = cmr12 at 25pt
...
\title{\myfonttitulo{Sobre el espacio de funciones \\continuas, nunca derivables}\\{\vspace{1cm}\Large Universidad Panamericana}}
\author{Diego Arceo Félix}
\date{Matemáticas Aplicadas }
...
%%%% Capítulo 1
\include{Cap1/intro_cap1}
\include{Cap1/weier}
\include{Cap1/Peano}
\include{Cap1/McCarthy}
\include{Cap1/lynch}

%%%% Capítulo 2
\include{Cap2/intro_cap2}
\include{Cap2/nociones_topo}
\include{Cap2/prevalencia}

%%% Capítulo 3
\include{Cap3/intro_cap3}
\include{Cap3/sondas}
\include{Cap3/prevalencia_ND}
