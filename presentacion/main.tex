...
\begin{frame}[plain,noframenumbering]{Índice} \tableofcontents \end{frame}
...
\sectionFrame{
    ...
    Por el lema anterior $P = \langle g,\, h\rangle$ es una sonda de $\mathcal{NL}[0,1]$. Como $\mathcal{NL}[0,1]\subseteq \mathcal{ND}[0,1]$, entonces $\mathcal{ND}[0,1]$ es prevalente. 
}
