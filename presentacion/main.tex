...
\sectionFrame[1]{
    En 1936 Stephan Mazurkiewicz probó que $\mathcal{ND}[0,1]$ no es un subconjunto de Borel de $C[0,1]$. Por esta razón, trabajaremos con otro conjunto un poco más fácil de manejar:
}
\sectionFrame{
    \definitionBlock[]{
...
\sectionFrame{
    \propositionBlock[]{
        Si $M>0$, entonces
        \begin{enumerate}
            \item[(1)] $\mathcal{NL}_M[a,b]$ es abierto en $C[a,b]$,
