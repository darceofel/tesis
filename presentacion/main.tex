...
\sectionFrame{
    Los conjuntos tímidos serán nuestra generalización de los conjuntos de de medida lebesgue cero. 
    \propositionBlock[]{
...
\sectionFrame{
    Para continuar con las otras características, antes debemos dar una breve vuelta por resultados sobre medidas en espacios producto.
    \notationBlock[]{
