...
\newcommand{\contentBlock}[4][structure.fg]{%
    ...
    {%
        \setbeamercolor{block title example}{bg=#1!70!black, fg=white}%
...
\newcommand{\definitionBlock}[2][]{
    \contentBlock{Definición}{#1}{#2}
}

\newcommand{\theoremBlock}[2][]{%
    \contentBlock[red]{Teorema}{#1}{#2}
}

\newcommand{\exampleBlock}[2][]{%
    \contentBlock[green!75!black]{Ejemplo}{#1}{#2}
}

\newcommand{\propositionBlock}[2][]{%
    \contentBlock[orange]{Proposición}{#1}{#2}
}

\newcommand{\observationBlock}[2][]{
    \contentBlock[purple]{Observación}{#1}{#2}
}

\newcommand{\lemmaBlock}[2][]{
    \contentBlock[gray]{Lema}{#1}{#2}
}
...
\sectionFrame{
    ...
    \newline
    \begin{center}
        ¿Existe alguna medida util en $C[0,1]$?
    \end{center}
